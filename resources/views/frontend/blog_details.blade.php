    ...
    <div class="breadcrumb-wrapper light-bg">
        <div class="container">
            ...
            <div class="breadcrumb-content">
                <h1 class="breadcrumb-title pb-0">Blog Detail</h1>
                    ...
                    <div class="breadcrumb-menu-wrap">
                        <div class="breadcrumb-menu">
                            <ul>
                                ...
                                <li aria-current="page">Blog Detail</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="lonyo-blog-d-wrap">
                        <div class="lonyo-blog-d-thumb" data-aos="fade-up" data-aos-duration="700">
                            <img 
                            src="{{ !empty($blog->image) ? Storage::url($blog->image) : asset('frontend/assets/images/blog/b7.png') }}" 
                            alt="{{ $blog->title }}"
                            >
                        </div>
