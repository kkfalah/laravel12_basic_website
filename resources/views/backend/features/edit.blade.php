    ...
    <div class="content">
        <div class="container-xxl">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="text-end">
                    <a href="{{ route('admin.feature.index') }}" class="btn btn-primary">Back</a>
                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-xl-6">
                                                                ...
                                                                <div class="form-group mb-3 row">
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        <textarea class="form-control" rows="3" name="description" id="description" placeholder="description">{{ old('description', $feature->description) }} </textarea>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-xl-6">
                                                                ...
                                                                <div class="form-group mb-3 row">
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        <img id="showImage"
                                                                            src="{{ !empty($feature->image) ? Storage::url($feature->image) : asset('backend/assets/images/default-image.png') }}"
