                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-xl-6">
                                                                ...
                                                                <div class="form-group mb-3 row">
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        ...
                                                                        <textarea class="form-control" name="description" id="description" style="display: none" placeholder="description"></textarea>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-xl-6">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        @foreach ($categories as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                @if ($blog->category_id == $item->id) selected @endif>
                                                                                {{ $item->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('category_id')
                                                                ...
                                                                <div class="form-group mb-3 row">
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        <img id="showImage"
                                                                            src="{{ !empty($blog->image) ? Storage::url($blog->image) : asset('backend/assets/images/default-profile.jpg') }}"
